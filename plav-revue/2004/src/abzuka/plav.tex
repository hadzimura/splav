...
\DeclareFontFamily{IL2}{cyr}{}
\DeclareFontShape{IL2}{cyr}{m}{n}{<-> wncyr10}{}
\DeclareFontShape{IL2}{sld}{b}{n}{<-> wncyb10}{}
\DeclareFontShape{IL2}{sld}{m}{it}{<-> wncyi10}{}
...
\def\ps@title{
\renewcommand{\@oddhead}{\includegraphics[width=\textwidth]{obrs/zahlavi}}
\renewcommand{\@evenhead}{\includegraphics[width=\textwidth]{obrs/zahlavi}}
...
\def\hlavicka#1#2{
\thispagestyle{title}
\vspace*{4.85\baselineskip}
\noindent{\color{white}\bf ~ #1 \hfill #2~~~}
